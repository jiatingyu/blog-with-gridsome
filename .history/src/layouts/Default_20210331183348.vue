...
export default {
  ...
  data() {
    return {
      ...
      blogDescribe: "",
      avatarUrl:
        "https://avatars.githubusercontent.com/u/32293220?s=400&u=c7286d64259d98a4d5a89965fede0e3f08d8a5b9&v=4",
      name: "贾廷玉",
      location: "四川 成都",
      blog: "",
      fontColor: "#ffffff",
  ...
  methods: {
    ...
    changeTime(time) {},
    changeVolume(v) {
      if (this.music.volume + v >= 100) {
        this.music.volume = 100;
      } else if (this.music.volume + v <= 0) {
        this.music.volume = 0;
      } else {
